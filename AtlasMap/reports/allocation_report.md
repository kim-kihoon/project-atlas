...
Generated: 2026-07-15T21:55:24.293245+00:00
...
| KR-42 | 강원 / Gangwon | 28 | 28 | 0 |
| KR-43 | 충북 / Chungbuk | 12 | 12 | 0 |
| KR-44 | 충남 / Chungnam | 14 | 11 | -3 |
| KR-45 | 전북 / Jeonbuk | 13 | 16 | 3 |
| KR-46 | 전남 / Jeonnam | 20 | 18 | -2 |
| KR-47 | 경북 / Gyeongbuk | 30 | 28 | -2 |
| KR-48 | 경남 / Gyeongnam | 17 | 18 | 1 |
| KR-49 | 제주 / Jeju | 3 | 3 | 0 |
| KP-01 | 평양 / Pyongyang | 5 | 4 | -1 |
| KP-02 | 평안남도 / South Pyongan | 20 | 17 | -3 |
| KP-03 | 평안북도 / North Pyongan | 20 | 19 | -1 |
| KP-04 | 자강도 / Chagang | 27 | 26 | -1 |
| KP-05 | 황해남도 / South Hwanghae | 14 | 14 | 0 |
| KP-06 | 황해북도 / North Hwanghae | 13 | 18 | 5 |
| KP-07 | 강원도 / Kangwon | 18 | 18 | 0 |
| KP-08 | 함경남도 / South Hamgyong | 31 | 33 | 2 |
| KP-09 | 함경북도 / North Hamgyong | 27 | 30 | 3 |
| KP-10 | 량강도 / Ryanggang | 23 | 24 | 1 |
| KP-13 | 라선 / Rason | 1 | 1 | 0 |

## Admin-1 representation assignments

- `KOR_P_R100030_C100017`: KR-46 -> KR-29; assigned overlap 294.725 km2
- `KOR_P_R100035_C100018`: KR-44 -> KR-30; assigned overlap 216.035 km2
- `KOR_P_R100036_C100018`: KR-44 -> KR-50; assigned overlap 172.676 km2
- `KOR_P_R100041_C100016`: KR-41 -> KR-28; assigned overlap 216.217 km2
- `KOR_P_R100042_C100017`: KR-41 -> KR-11; assigned overlap 248.243 km2
...
- Dominant-overlap fill tiles: 90
...
- Capital tiles outlined in yellow: 4
- Metropolis tiles: 15
- City tiles: 82
- Player city-upgrade eligible tiles: 65
- Qualifying real cities without a distinct tile at this resolution: 15
  - `KP-02:chollima`: Kangson (102,436)
  - `KP-02:mundok`: Paek'Ak (125,924)
  - `KP-06:songrim-city`: Songnim Ni (152,425)
  - `KR-41:ansan`: Ansan (623,256)
  - `KR-41:anyang`: Anyang (595,644)
  - `KR-41:bucheon`: Bucheon (850,731)
  - `KR-41:gimpo`: Gimpo (486,258)
  ...
  - `KR-48:geoje`: Geoje (232,921)
- KOR: tile sum 51,600,388; UN WPP target 51,600,388; raw WorldPop weight sum 5,795,387.34
- PRK: tile sum 26,633,691; UN WPP target 26,633,691; raw WorldPop weight sum 16,206,218.39
...
- `KOR_P_R100029_C100016` -> `KR-46`; intersects KR-29, KR-46
- `KOR_P_R100029_C100019` -> `KR-46`; intersects KR-46, KR-48
- `KOR_P_R100030_C100016` -> `KR-46`; intersects KR-29, KR-46
...
- `KOR_P_R100030_C100023` -> `KR-48`; intersects KR-26, KR-48
...
- `KOR_P_R100032_C100022` -> `KR-48`; intersects KR-27, KR-47, KR-48
- `KOR_P_R100032_C100023` -> `KR-48`; intersects KR-47, KR-48
- `KOR_P_R100032_C100024` -> `KR-48`; intersects KR-31, KR-47, KR-48
...
- `KOR_P_R100033_C100021` -> `KR-47`; intersects KR-27, KR-47, KR-48
- `KOR_P_R100033_C100022` -> `KR-27`; intersects KR-27, KR-47, KR-48
- `KOR_P_R100033_C100023` -> `KR-47`; intersects KR-27, KR-47
- `KOR_P_R100033_C100024` -> `KR-47`; intersects KR-31, KR-47
- `KOR_P_R100033_C100025` -> `KR-47`; intersects KR-31, KR-47
...
- `KOR_P_R100034_C100020` -> `KR-45`; intersects KR-43, KR-45, KR-47, KR-48
- `KOR_P_R100034_C100022` -> `KR-47`; intersects KR-27, KR-47
- `KOR_P_R100034_C100023` -> `KR-27`; intersects KR-27, KR-47
- `KOR_P_R100035_C100016` -> `KR-44`; intersects KR-44, KR-45
- `KOR_P_R100035_C100017` -> `KR-44`; intersects KR-44, KR-45
- `KOR_P_R100035_C100018` -> `KR-30`; intersects KR-30, KR-43, KR-44, KR-45
- `KOR_P_R100035_C100019` -> `KR-43`; intersects KR-43, KR-44
- `KOR_P_R100035_C100020` -> `KR-43`; intersects KR-43, KR-47
- `KOR_P_R100035_C100022` -> `KR-27`; intersects KR-27, KR-47
- `KOR_P_R100035_C100023` -> `KR-47`; intersects KR-27, KR-47
- `KOR_P_R100036_C100018` -> `KR-50`; intersects KR-30, KR-44, KR-50
- `KOR_P_R100036_C100019` -> `KR-43`; intersects KR-30, KR-43, KR-50
- `KOR_P_R100036_C100020` -> `KR-43`; intersects KR-43, KR-47
- `KOR_P_R100036_C100022` -> `KR-47`; intersects KR-27, KR-47
- `KOR_P_R100037_C100017` -> `KR-44`; intersects KR-44, KR-50
- `KOR_P_R100037_C100018` -> `KR-43`; intersects KR-30, KR-43, KR-44, KR-50
...
- `KOR_P_R100038_C100018` -> `KR-44`; intersects KR-41, KR-43, KR-44, KR-50
- `KOR_P_R100038_C100019` -> `KR-43`; intersects KR-43, KR-44
...
- `KOR_P_R100039_C100019` -> `KR-43`; intersects KR-41, KR-43
- `KOR_P_R100039_C100021` -> `KR-43`; intersects KR-42, KR-43
- `KOR_P_R100039_C100022` -> `KR-47`; intersects KR-42, KR-43, KR-47
- `KOR_P_R100039_C100023` -> `KR-47`; intersects KR-42, KR-47
- `KOR_P_R100039_C100024` -> `KR-47`; intersects KR-42, KR-47
- `KOR_P_R100040_C100019` -> `KR-41`; intersects KR-41, KR-43
...
- `KOR_P_R100040_C100025` -> `KR-42`; intersects KR-42, KR-47
- `KOR_P_R100041_C100016` -> `KR-28`; intersects KR-11, KR-28, KR-41
- `KOR_P_R100041_C100017` -> `KR-41`; intersects KR-11, KR-41
- `KOR_P_R100041_C100019` -> `KR-41`; intersects KR-41, KR-42
- `KOR_P_R100042_C100016` -> `KR-41`; intersects KR-28, KR-41
- `KOR_P_R100042_C100017` -> `KR-11`; intersects KR-11, KR-28, KR-41
...
- `KOR_P_R100043_C100018` -> `KR-41`; intersects KR-41, KR-42
- `KOR_P_R100043_C100019` -> `KR-42`; intersects KR-41, KR-42
- `KOR_P_R100044_C100017` -> `KR-41`; intersects KP-06, KP-07, KR-41
- `KOR_P_R100044_C100018` -> `KR-41`; intersects KR-41, KR-42
- `KOR_P_R100044_C100019` -> `KR-42`; intersects KR-41, KR-42
- `KOR_P_R100045_C100018` -> `KR-42`; intersects KP-07, KR-41, KR-42
...
- `PRK_P_R100043_C100014` -> `KP-05`; intersects KP-05, KR-28
- `PRK_P_R100043_C100015` -> `KP-06`; intersects KP-05, KP-06, KR-28, KR-41
- `PRK_P_R100044_C100014` -> `KP-05`; intersects KP-05, KP-06
- `PRK_P_R100044_C100015` -> `KP-05`; intersects KP-05, KP-06
- `PRK_P_R100044_C100016` -> `KP-06`; intersects KP-06, KR-41
